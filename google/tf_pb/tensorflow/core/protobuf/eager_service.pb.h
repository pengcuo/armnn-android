...
class SendTensorOp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.eager.SendTensorOp) */ {
 public:
  ...
  inline SendTensorOp* New() const PROTOBUF_FINAL { return New(NULL); }

  SendTensorOp* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprotobuf_2feager_5fservice_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2feager_5fservice_2eproto::InitDefaultsSendTensorOpImpl();
};
// -------------------------------------------------------------------
