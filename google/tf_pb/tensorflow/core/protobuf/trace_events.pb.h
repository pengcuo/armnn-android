...
#ifndef PROTOBUF_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto__INCLUDED
#define PROTOBUF_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsTrace_DevicesEntry_DoNotUse();
  InitDefaultsTrace();
  InitDefaultsDevice_ResourcesEntry_DoNotUse();
  InitDefaultsDevice();
  InitDefaultsResource();
  InitDefaultsTraceEvent_ArgsEntry_DoNotUse();
  InitDefaultsTraceEvent();
}
}  // namespace protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto
...
class Trace : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.profiler.Trace) */ {
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::InitDefaultsTraceImpl();
};
// -------------------------------------------------------------------
...
class Device : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.profiler.Device) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::InitDefaultsDeviceImpl();
};
// -------------------------------------------------------------------
...
class Resource : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.profiler.Resource) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::InitDefaultsResourceImpl();
};
// -------------------------------------------------------------------
...
class TraceEvent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.profiler.TraceEvent) */ {
 public:
  ...
  inline TraceEvent* New() const PROTOBUF_FINAL { return New(NULL); }

  TraceEvent* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto::InitDefaultsTraceEventImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_tensorflow_2fcore_2fprotobuf_2ftrace_5fevents_2eproto__INCLUDED
