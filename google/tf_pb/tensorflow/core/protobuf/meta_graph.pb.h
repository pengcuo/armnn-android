...
class TensorInfo_CompositeTensor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorInfo.CompositeTensor) */ {
 public:
  ...
  inline TensorInfo_CompositeTensor* New() const PROTOBUF_FINAL { return New(NULL); }

  TensorInfo_CompositeTensor* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
