...
class VerifierConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VerifierConfig) */ {
 public:
  ...
  inline VerifierConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  VerifierConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2fverifier_5fconfig_2eproto::InitDefaultsVerifierConfigImpl();
};
// ===================================================================
