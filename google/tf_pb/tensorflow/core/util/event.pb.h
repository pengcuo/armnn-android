...
class RequestedExitCode : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.RequestedExitCode) */ {
 public:
  ...
  inline RequestedExitCode* New() const PROTOBUF_FINAL { return New(NULL); }

  RequestedExitCode* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsRequestedExitCodeImpl();
};
// -------------------------------------------------------------------
