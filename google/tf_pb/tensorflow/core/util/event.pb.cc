...
void InitDefaultsRequestedExitCodeImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsRequestedExitCode() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsRequestedExitCodeImpl);
}
...
void InitDefaultsWorkerHeartbeatRequestImpl() {
  ...
  protobuf_tensorflow_2fcore_2futil_2fevent_2eproto::InitDefaultsRequestedExitCode();
  {
...
RequestedExitCode* RequestedExitCode::New(::google::protobuf::Arena* arena) const {
  return ::google::protobuf::Arena::CreateMessage<RequestedExitCode>(arena);
}
...
void WorkerHeartbeatRequest::_slow_mutable_exit_code() {
  exit_code_ = ::google::protobuf::Arena::CreateMessage< ::tensorflow::RequestedExitCode >(
      GetArenaNoVirtual());
}
...
::google::protobuf::uint8* WorkerHeartbeatRequest::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_exit_code()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, *this->exit_code_, deterministic, target);
  }
