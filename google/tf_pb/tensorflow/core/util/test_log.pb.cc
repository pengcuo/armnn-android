...
void InitDefaultsRunConfiguration_EnvVarsEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsRunConfiguration_EnvVarsEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsRunConfiguration_EnvVarsEntry_DoNotUseImpl);
}
...
void InitDefaultsRunConfigurationImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2futil_2ftest_5flog_2eproto::InitDefaultsRunConfiguration_EnvVarsEntry_DoNotUse();
  {
...
void RunConfiguration::SerializeWithCachedSizes(
  ...
  if (!this->env_vars().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      ::google::protobuf::scoped_ptr<RunConfiguration_EnvVarsEntry_DoNotUse> entry;
      for (size_type i = 0; i < n; i++) {
