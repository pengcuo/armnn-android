...
void InitDefaultsResourceHandleProto_DtypeAndShape() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsResourceHandleProto_DtypeAndShapeImpl);
}
...
void InitDefaultsResourceHandleProtoImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto::InitDefaultsResourceHandleProto_DtypeAndShape();
  {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_dtypes_and_shapes()));
        } else {
          goto handle_unusual;
        }
        break;
...
void ResourceHandleProto::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->dtypes_and_shapes(static_cast<int>(i)), output);
  }
