...
void AddDescriptors();
void InitDefaultsResourceHandleProto_DtypeAndShapeImpl();
void InitDefaultsResourceHandleProto_DtypeAndShape();
void InitDefaultsResourceHandleProtoImpl();
void InitDefaultsResourceHandleProto();
inline void InitDefaults() {
  InitDefaultsResourceHandleProto_DtypeAndShape();
...
class ResourceHandleProto_DtypeAndShape : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ResourceHandleProto.DtypeAndShape) */ {
 public:
  ...
  inline ResourceHandleProto_DtypeAndShape* New() const PROTOBUF_FINAL { return New(NULL); }

  ResourceHandleProto_DtypeAndShape* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto::InitDefaultsResourceHandleProto_DtypeAndShapeImpl();
};
// -------------------------------------------------------------------
