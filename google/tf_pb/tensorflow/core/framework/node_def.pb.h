...
void InitDefaultsNodeDef_ExperimentalDebugInfoImpl();
void InitDefaultsNodeDef_ExperimentalDebugInfo();
void InitDefaultsNodeDefImpl();
void InitDefaultsNodeDef();
inline void InitDefaults() {
  InitDefaultsNodeDef_AttrEntry_DoNotUse();
  InitDefaultsNodeDef_ExperimentalDebugInfo();
  InitDefaultsNodeDef();
}
}  // namespace protobuf_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto
...
class NodeDef_ExperimentalDebugInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NodeDef.ExperimentalDebugInfo) */ {
 public:
  ...
  inline NodeDef_ExperimentalDebugInfo* New() const PROTOBUF_FINAL { return New(NULL); }

  NodeDef_ExperimentalDebugInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::InitDefaultsNodeDef_ExperimentalDebugInfoImpl();
};
// -------------------------------------------------------------------
