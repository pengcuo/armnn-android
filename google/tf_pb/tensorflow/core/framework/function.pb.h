...
inline void InitDefaults() {
  ...
  InitDefaultsFunctionDef_ArgAttrs_AttrEntry_DoNotUse();
  InitDefaultsFunctionDef_ArgAttrs();
  InitDefaultsFunctionDef_ArgAttrEntry_DoNotUse();
  InitDefaultsFunctionDef_RetEntry_DoNotUse();
  InitDefaultsFunctionDef_ControlRetEntry_DoNotUse();
...
class FunctionDef_ArgAttrs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FunctionDef.ArgAttrs) */ {
 public:
  ...
  inline FunctionDef_ArgAttrs* New() const PROTOBUF_FINAL { return New(NULL); }

  FunctionDef_ArgAttrs* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDef_ArgAttrsImpl();
};
// -------------------------------------------------------------------
