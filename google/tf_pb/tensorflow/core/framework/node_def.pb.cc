...
void InitDefaultsNodeDef_ExperimentalDebugInfo() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsNodeDef_ExperimentalDebugInfoImpl);
}
...
void InitDefaultsNodeDefImpl() {
  ...
  protobuf_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::InitDefaultsNodeDef_ExperimentalDebugInfo();
  {
  ...
  if (this->has_experimental_debug_info()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, *this->experimental_debug_info_, deterministic, target);
  }
