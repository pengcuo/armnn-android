    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_default_graph_input_tensor_shape()));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_default_graph_output_tensor_shape()));
        } else {
          goto handle_unusual;
        }
        break;
